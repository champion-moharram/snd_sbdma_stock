...
from snd_sbdma_stock.snd_sbdma_stock.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from snd_sbdma_stock.snd_sbdma_stock.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from snd_sbdma_stock.snd_sbdma_stock.doctype.budget.budget import validate_expense_against_budget
from snd_sbdma_stock.accounts.utils import create_payment_ledger_entry
from snd_sbdma_stock.exceptions import InvalidAccountDimensionError, MandatoryAccountDimensionError
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else snd_sbdma_stock.get_default_company()
	company_currency = snd_sbdma_stock.get_company_currency(company)
