...
from snd_sbdma_stock.exceptions import InvalidAccountCurrency, PartyDisabled, PartyFrozen
...
def set_taxes(
	...
	from snd_sbdma_stock.snd_sbdma_stock.doctype.tax_rule.tax_rule import get_party_details, get_tax_template
