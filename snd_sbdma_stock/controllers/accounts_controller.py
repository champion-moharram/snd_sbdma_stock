...
from snd_sbdma_stock.snd_sbdma_stock.doctype.accounting_dimension.accounting_dimension import (
	get_accounting_dimensions,
	get_dimensions,
)
from snd_sbdma_stock.snd_sbdma_stock.doctype.pricing_rule.utils import (
	apply_pricing_rule_for_free_items,
	apply_pricing_rule_on_transaction,
	get_applied_pricing_rules,
)
from snd_sbdma_stock.accounts.general_ledger import get_round_off_account_and_cost_center
from snd_sbdma_stock.accounts.party import (
	get_party_account,
	get_party_account_currency,
	get_party_gle_currency,
	validate_party_frozen_disabled,
)
from snd_sbdma_stock.accounts.utils import (
...
from snd_sbdma_stock.buying.utils import update_last_purchase_rate
from snd_sbdma_stock.controllers.print_settings import (
	set_print_templates_for_item_table,
	set_print_templates_for_taxes,
)
from snd_sbdma_stock.controllers.sales_and_purchase_return import validate_return
from snd_sbdma_stock.exceptions import InvalidCurrency
from snd_sbdma_stock.setup.utils import get_exchange_rate
from snd_sbdma_stock.snd_sbdma_stock.doctype.item.item import get_uom_conv_factor
...
from snd_sbdma_stock.utilities.regional import temporary_flag
from snd_sbdma_stock.utilities.transaction_base import TransactionBase
...
class AccountsController(TransactionBase):
	...
	def company_currency(self):
		if not hasattr(self, "__company_currency"):
			self.__company_currency = snd_sbdma_stock.get_company_currency(self.company)
...
# 		set_print_templates_for_taxes(self, settings)
	...
	def calculate_taxes_and_totals(self):
		from snd_sbdma_stock.controllers.taxes_and_totals import calculate_taxes_and_totals
	...
	def validate_due_date(self):
		...
		from snd_sbdma_stock.accounts.party import validate_due_date
	...
	def set_missing_item_details(self, for_validate=False):
		...
		from snd_sbdma_stock.snd_sbdma_stock.doctype.serial_no.serial_no import get_serial_nos
			...
			for item in self.get("items"):
				if item.get("item_code"):
					...
					if hasattr(item, "cost_center") and not item.get("cost_center"):
						item.set(
							"cost_center",
							self.get("cost_center") or snd_sbdma_stock.get_default_cost_center(self.company),
						)
...
# 		return False
	...
	def update_against_document_in_jv(self):
		...
		if lst:
			from snd_sbdma_stock.accounts.utils import reconcile_against_document
...
# 			)
	...
	def validate_multiple_billing(self, ref_dt, item_ref_dn, based_on):
		from snd_sbdma_stock.controllers.status_updater import get_allowance_for
...
# 		jv.submit()
	...
	def check_conversion_rate(self):
		default_currency = snd_sbdma_stock.get_company_currency(self.company)
