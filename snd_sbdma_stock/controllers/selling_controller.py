...
from snd_sbdma_stock.accounts.party import render_address
from snd_sbdma_stock.controllers.accounts_controller import get_taxes_and_charges
...
from snd_sbdma_stock.snd_sbdma_stock.doctype.item.item import set_item_default
from snd_sbdma_stock.snd_sbdma_stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from snd_sbdma_stock.accounts.party import _get_party_details
	...
	def validate_items(self):
		...
		from snd_sbdma_stock.controllers.buying_controller import validate_item_type
