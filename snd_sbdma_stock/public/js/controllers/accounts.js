	...
	onload: function(frm) {
		if(frm.get_field("taxes")) {
			frm.set_query("account_head", "taxes", function(doc) {
				...
				return {
					query: "snd_sbdma_stock.controllers.queries.tax_account_query",
					filters: {
...
var get_payment_mode_account = function(frm, mode_of_payment, callback) {
	...
	return  frappe.call({
		method: "snd_sbdma_stock.snd_sbdma_stock.doctype.sales_invoice.sales_invoice.get_bank_cash_account",
		args: {
...
cur_frm.cscript.account_head = function(doc, cdt, cdn) {
	...
	if(!d.charge_type && d.account_head){
		...
		frappe.call({
			type:"GET",
			method: "snd_sbdma_stock.controllers.accounts_controller.get_tax_rate",
