...
$.extend(erpnext.queries, {
	...
	lead: function () {
		return { query: "snd_sbdma_stock.controllers.queries.lead_query" };
	},
	...
	item: function (filters) {
		var args = { query: "snd_sbdma_stock.controllers.queries.item_query" };
		if (filters) args["filters"] = filters;
		return args;
	},

	bom: function () {
		return { query: "snd_sbdma_stock.controllers.queries.bom" };
	},

	task: function () {
		return { query: "snd_sbdma_stock.projects.utils.query_task" };
	},
	...
	employee: function () {
		return { query: "snd_sbdma_stock.controllers.queries.employee_query" };
	},
	...
	get_filtered_dimensions: function (doc, child_fields, dimension, company) {
		...
		return {
			query: "snd_sbdma_stock.controllers.queries.get_filtered_dimensions",
			filters: {
				dimension: dimension,
				account: account,
				company: company,
...
erpnext.queries.setup_warehouse_query = function (frm) {
	frm.set_query("warehouse", "items", function (doc, cdt, cdn) {
		...
		if (row.item_code) {
			$.extend(filters, { query: "snd_sbdma_stock.controllers.queries.warehouse_query" });
