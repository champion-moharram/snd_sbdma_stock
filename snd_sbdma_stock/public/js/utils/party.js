...
frappe.provide("snd_sbdma_stock.utils");
...
erpnext.utils.get_party_details = function (frm, method, args, callback) {
	if (!method) {
		method = "snd_sbdma_stock.accounts.party.get_party_details";
	}
...
erpnext.utils.set_taxes_from_address = function (
	...
	frappe.call({
		method: "snd_sbdma_stock.accounts.party.get_address_tax_category",
		args: {
...
erpnext.utils.set_taxes = function (frm, triggered_from_field) {
	...
	frappe.call({
		method: "snd_sbdma_stock.accounts.party.set_taxes",
		args: {
			party: party,
			party_type: party_type,
...
erpnext.utils.get_shipping_address = function (frm, callback) {
	if (frm.doc.company) {
		...
		frappe.call({
			method: "snd_sbdma_stock.accounts.custom.address.get_shipping_address",
			args: {
				company: frm.doc.company,
