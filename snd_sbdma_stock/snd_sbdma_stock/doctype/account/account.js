	...
	merge_account: function (frm) {
		var d = new frappe.ui.Dialog({
			...
			primary_action: function () {
				...
				frappe.call({
					method: "snd_sbdma_stock.snd_sbdma_stock.doctype.account.account.merge_account",
					args: {
						old: frm.doc.name,
						new: data.name,
					},
	...
	update_account_number: function (frm) {
		var d = new frappe.ui.Dialog({
			...
			primary_action: function () {
				...
				frappe.call({
					method: "snd_sbdma_stock.snd_sbdma_stock.doctype.account.account.update_account_number",
					args: {
