...
class Account(NestedSet):
	...
	def autoname(self):
		from snd_sbdma_stock.accounts.utils import get_autoname_with_number

		self.name = get_autoname_with_number(self.account_number, self.account_name, self.company)

	def validate(self):
		from snd_sbdma_stock.accounts.utils import validate_field_number
	...
	def validate_balance_must_be_debit_or_credit(self):
		from snd_sbdma_stock.accounts.utils import get_balance_on
				...
				doc.update(
					{
						...
						else snd_sbdma_stock.get_company_currency(company),
