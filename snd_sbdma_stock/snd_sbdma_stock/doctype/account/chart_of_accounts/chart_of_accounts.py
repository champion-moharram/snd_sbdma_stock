...
def add_suffix_if_duplicate(account_name, account_number, accounts):
	if account_number:
		account_name_in_db = ''
#   unidecode(" - ".join([account_number, account_name.strip().lower()]))
	else:
		account_name_in_db = ''
#   unidecode(account_name.strip().lower())
...
def get_chart(chart_template, existing_company=None):
	...
	if existing_company:
		...
		from snd_sbdma_stock.snd_sbdma_stock.doctype.account.chart_of_accounts.verified import (
