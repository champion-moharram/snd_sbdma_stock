...
{% include 'snd_sbdma_stock/public/js/controllers/buying.js' %};
...
frappe.ui.form.on('Material Request', {
	...
	update_status: function(frm, stop_status) {
		frappe.call({
			method: 'snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.update_status',
	...
	get_items_from_sales_order: function(frm) {
		erpnext.utils.map_current_doc({
			method: "snd_sbdma_stock.snd_sbdma_stock.doctype.sales_order.sales_order.make_material_request",
		...
		frappe.prompt(
			{
				...
				get_query: () => {
					return{
						query: "snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.get_default_supplier_query",
			...
			(values) => {
				frappe.model.open_mapped_doc({
					method: "snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.make_purchase_order",
					frm: frm,
	...
	make_request_for_quotation: function(frm) {
		frappe.model.open_mapped_doc({
			method: "snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.make_request_for_quotation",
			frm: frm,
			run_link_triggers: true
		});
	},
	...
	make_supplier_quotation: function(frm) {
		frappe.model.open_mapped_doc({
			method: "snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.make_supplier_quotation",
			frm: frm
		});
	},
	...
	make_in_transit_stock_entry(frm) {
		frappe.prompt(
			...
			(values) => {
				frappe.call({
					method: "snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.make_in_transit_stock_entry",
					args: {
	...
	create_pick_list: (frm) => {
		frappe.model.open_mapped_doc({
			method: "snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.create_pick_list",
			frm: frm
		});
	},
	...
	raise_work_orders: function(frm) {
		frappe.call({
			method:"snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.raise_work_orders",
			args: {
