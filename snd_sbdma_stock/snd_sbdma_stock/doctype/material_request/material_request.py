...
from snd_sbdma_stock.snd_sbdma_stock.doctype.work_order.work_order import get_item_details
from snd_sbdma_stock.snd_sbdma_stock.doctype.item.item import get_item_defaults
from snd_sbdma_stock.snd_sbdma_stock.stock_balance import get_indented_qty, update_bin_qty
...
class MaterialRequest(BuyingController):
	...
	def validate(self):
		...
		from snd_sbdma_stock.controllers.status_updater import validate_status
