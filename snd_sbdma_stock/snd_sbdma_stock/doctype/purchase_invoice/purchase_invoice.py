...
import snd_sbdma_stock
# from erpnext.accounts.deferred_revenue import validate_service_stop_date
from snd_sbdma_stock.snd_sbdma_stock.doctype.gl_entry.gl_entry import update_outstanding_amt
...
from snd_sbdma_stock.snd_sbdma_stock.doctype.tax_withholding_category.tax_withholding_category import (
	get_party_tax_withholding_details,
)
from snd_sbdma_stock.accounts.general_ledger import (
	get_round_off_account_and_cost_center,
	make_gl_entries,
	make_reverse_gl_entries,
	merge_similar_entries,
)
from snd_sbdma_stock.accounts.party import get_due_date, get_party_account
from snd_sbdma_stock.accounts.utils import get_account_currency, get_fiscal_year
from snd_sbdma_stock.snd_sbdma_stock.doctype.asset.asset import is_cwip_accounting_enabled
from snd_sbdma_stock.snd_sbdma_stock.doctype.asset_category.asset_category import get_asset_category_account
from snd_sbdma_stock.buying.utils import check_on_hold_or_closed_status
from snd_sbdma_stock.controllers.accounts_controller import validate_account_head
from snd_sbdma_stock.controllers.buying_controller import BuyingController
from snd_sbdma_stock.snd_sbdma_stock import get_warehouse_account_map
...
class PurchaseInvoice(BuyingController):
	...
	def set_expense_account(self, for_validate=False):
		auto_accounting_for_stock = snd_sbdma_stock.is_perpetual_inventory_enabled(self.company)
	...
	def on_submit(self):
		...
		if self.update_stock == 1:
			...
			from snd_sbdma_stock.snd_sbdma_stock.doctype.serial_no.serial_no import update_serial_nos_after_submit
	...
	def get_gl_entries(self, warehouse_account=None):
		self.auto_accounting_for_stock = snd_sbdma_stock.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from snd_sbdma_stock.snd_sbdma_stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
...
def get_list_context(context=None):
	from snd_sbdma_stock.controllers.website_list_for_contact import get_list_context
...
@snd_sbdma_stock.allow_regional
...
def make_debit_note(source_name, target_doc=None):
	from snd_sbdma_stock.controllers.sales_and_purchase_return import make_return_doc
...
def make_inter_company_sales_invoice(source_name, target_doc=None):
	from snd_sbdma_stock.snd_sbdma_stock.doctype.sales_invoice.sales_invoice import make_inter_company_transaction
