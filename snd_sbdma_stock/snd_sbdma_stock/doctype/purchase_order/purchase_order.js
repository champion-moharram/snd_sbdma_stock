	...
	get_materials_from_supplier: function(frm) {
		...
		if (po_details && po_details.length) {
			frm.add_custom_button(__('Return of Components'), () => {
				frm.call({
					method: 'snd_sbdma_stock.controllers.subcontracting_controller.get_materials_from_supplier',
					freeze: true,
...
erpnext.buying.PurchaseOrderController = class PurchaseOrderController extends erpnext.buying.BuyingController {
	...
	get_items_from_open_material_requests() {
		erpnext.utils.map_current_doc({
			method: "snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.make_purchase_order_based_on_supplier",
			args: {
			...
			get_query_method: "snd_sbdma_stock.snd_sbdma_stock.doctype.material_request.material_request.get_material_requests_based_on_supplier"
		});
	}
	...
	make_stock_entry() {
		frappe.call({
			method:"snd_sbdma_stock.controllers.subcontracting_controller.make_rm_stock_entry",
			args: {
	...
	make_inter_company_order(frm) {
		frappe.model.open_mapped_doc({
			method: "snd_sbdma_stock.snd_sbdma_stock.doctype.purchase_order.purchase_order.make_inter_company_sales_order",
			frm: frm
		});
	}
	...
	make_purchase_receipt() {
		frappe.model.open_mapped_doc({
			method: "snd_sbdma_stock.snd_sbdma_stock.doctype.purchase_order.purchase_order.make_purchase_receipt",
			frm: cur_frm,
	...
	make_purchase_invoice() {
		frappe.model.open_mapped_doc({
			method: "snd_sbdma_stock.snd_sbdma_stock.doctype.purchase_order.purchase_order.make_purchase_invoice",
			frm: cur_frm
		})
	}
	...
	make_subcontracting_order() {
		frappe.model.open_mapped_doc({
			method: "snd_sbdma_stock.snd_sbdma_stock.doctype.purchase_order.purchase_order.make_subcontracting_order",
			frm: cur_frm,
	...
	add_from_mappers() {
		...
		this.frm.add_custom_button(__('Supplier Quotation'),
			function() {
				erpnext.utils.map_current_doc({
					method: "snd_sbdma_stock.snd_sbdma_stock.doctype.supplier_quotation.supplier_quotation.make_purchase_order",
		...
		function() {
			...
			frappe.call({
				method: "snd_sbdma_stock.buying.utils.get_linked_material_requests",
				args:{
					items: my_items
				},
				callback: function(r) {
...
cur_frm.cscript.update_status= function(label, status){
	frappe.call({
		method: "snd_sbdma_stock.snd_sbdma_stock.doctype.purchase_order.purchase_order.update_status",
