...
from snd_sbdma_stock.accounts.utils import get_account_currency
...
# from snd_sbdma_stock.controllers.accounts_controller import merge_taxes
from snd_sbdma_stock.controllers.buying_controller import BuyingController
from snd_sbdma_stock.snd_sbdma_stock.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
class PurchaseReceipt(BuyingController):
	...
	def make_item_gl_entries(self, gl_entries, warehouse_account=None):
		from snd_sbdma_stock.snd_sbdma_stock.doctype.purchase_invoice.purchase_invoice import (
		...
		for d in self.get("items"):
			if (
				...
				if not (
					(snd_sbdma_stock.is_perpetual_inventory_enabled(self.company) and d.item_code in stock_items)
...
def make_purchase_invoice(source_name, target_doc=None, args=None):
	from snd_sbdma_stock.accounts.party import get_payment_terms_template
