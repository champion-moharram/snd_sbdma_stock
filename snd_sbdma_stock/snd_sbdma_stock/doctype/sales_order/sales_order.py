...
from snd_sbdma_stock.accounts.party import get_party_account
from snd_sbdma_stock.controllers.selling_controller import SellingController
from snd_sbdma_stock.snd_sbdma_stock.doctype.blanket_order.blanket_order import (
	validate_against_blanket_order,
)
from snd_sbdma_stock.snd_sbdma_stock.doctype.production_plan.production_plan import (
	get_items_for_material_requests,
)
from snd_sbdma_stock.snd_sbdma_stock.doctype.customer.customer import check_credit_limit
...
from snd_sbdma_stock.snd_sbdma_stock.get_item_details import get_default_bom, get_price_list_rate
from snd_sbdma_stock.snd_sbdma_stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	def validate(self):
		...
		if self.coupon_code:
			from snd_sbdma_stock.snd_sbdma_stock.doctype.pricing_rule.utils import validate_coupon_code

			validate_coupon_code(self.coupon_code)

		from snd_sbdma_stock.snd_sbdma_stock.doctype.packed_item.packed_item import make_packing_list
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from snd_sbdma_stock.snd_sbdma_stock.doctype.pricing_rule.utils import update_coupon_code_count
...
def create_pick_list(source_name, target_doc=None):
	from snd_sbdma_stock.snd_sbdma_stock.doctype.packed_item.packed_item import is_product_bundle
