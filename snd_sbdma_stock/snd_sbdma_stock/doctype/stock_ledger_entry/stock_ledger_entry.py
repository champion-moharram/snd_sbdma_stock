...
from snd_sbdma_stock.accounts.utils import get_fiscal_year
from snd_sbdma_stock.controllers.item_variant import ItemTemplateCannotHaveStock
...
class StockLedgerEntry(Document):
	...
	def set_posting_datetime(self):
		from snd_sbdma_stock.snd_sbdma_stock.utils import get_combine_datetime
	...
	def on_submit(self):
		...
		if not self.get("via_landed_cost_voucher"):
			from snd_sbdma_stock.snd_sbdma_stock.doctype.serial_no.serial_no import process_serial_no
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from snd_sbdma_stock.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from snd_sbdma_stock.snd_sbdma_stock.utils import is_group_warehouse
