...
frappe.ui.form.on("Supplier", {
	setup: function (frm) {
		...
		frm.set_query("supplier_primary_contact", function (doc) {
			return {
				query: "snd_sbdma_stock.snd_sbdma_stock.doctype.supplier.supplier.get_supplier_primary_contact",
				filters: {
					supplier: doc.name,
				},
			};
	...
	show_party_link_dialog: function (frm) {
		const dialog = new frappe.ui.Dialog({
			...
			primary_action: function ({ customer }) {
				frappe.call({
					method: "snd_sbdma_stock.snd_sbdma_stock.doctype.party_link.party_link.create_party_link",
					args: {
