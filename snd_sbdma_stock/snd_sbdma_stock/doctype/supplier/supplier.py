...
class Supplier(TransactionBase):
	...
	def create_primary_contact(self):
		from snd_sbdma_stock.snd_sbdma_stock.doctype.customer.customer import make_contact
	...
	def create_primary_address(self):
		...
		from snd_sbdma_stock.snd_sbdma_stock.doctype.customer.customer import make_address
