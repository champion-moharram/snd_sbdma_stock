...
# from snd_sbdma_stock.snd_sbdma_stock.doctype.item_review.item_review import get_item_reviews
# from snd_sbdma_stock.e_commerce.redisearch_utils import (
# 	delete_item_from_index,
# 	insert_item_to_index,
# 	update_index_for_item,
# )
from snd_sbdma_stock.e_commerce.shopping_cart.cart import _set_price_list
from snd_sbdma_stock.snd_sbdma_stock.doctype.item_group.item_group import (
	get_parent_item_groups,
	invalidate_cache_for,
)
from snd_sbdma_stock.utilities.product import get_price
...
class WebsiteItem(WebsiteGenerator):
	...
	def set_shopping_cart_data(self, context):
		from snd_sbdma_stock.e_commerce.shopping_cart.product_info import get_product_info_for_website
...
def invalidate_cache_for_web_item(doc):
	...
	from snd_sbdma_stock.snd_sbdma_stock.doctype.item.item import invalidate_item_variants_cache_for_website
