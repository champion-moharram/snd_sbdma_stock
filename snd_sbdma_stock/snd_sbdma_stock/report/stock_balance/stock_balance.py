...
from snd_sbdma_stock.snd_sbdma_stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from snd_sbdma_stock.snd_sbdma_stock.utils import add_additional_uom_columns
...
class StockBalanceReport:
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = snd_sbdma_stock.get_company_currency(self.filters.get("company"))
		else:
