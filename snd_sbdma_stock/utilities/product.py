...
from snd_sbdma_stock.snd_sbdma_stock.doctype.pricing_rule.pricing_rule import get_pricing_rule_for_item
...
def get_price(item_code, price_list, customer_group, company, qty=1):
	from snd_sbdma_stock.e_commerce.shopping_cart.cart import get_party
